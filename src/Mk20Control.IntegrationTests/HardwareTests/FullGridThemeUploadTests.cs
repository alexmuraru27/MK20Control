...
/// <see cref="DevicePaths.FullGrid"/> by default (override via
/// <c>MK20_UPLOAD_DEVICE_PATH</c>). Requires <c>MK20_COM_PORT</c> - see
...
public class FullGridThemeUploadTests
{
    ...
    {
        string devicePath = DevicePaths.Resolve(DevicePaths.FullGrid);
